...
import { ServiceCommoncategories, WomenpreneursCommoncategories, CategoryServiceFilter } from './../../../services/service-category-service/service-category-services';

import Button from 'react-bootstrap/Button';
import Modal from 'react-bootstrap/Modal';
function SidebarServicecateogrys({ setFilterproducts, setLoadingproduct, setProductgetloading, setPagecount, pagecountnumbers, setFilterproducts1,setServiceCategoryShow,serviceCategoryshow }) {
  ...
  useEffect(() => {
    ...
    ServiceCommoncategories().then((res) => {
    ...
    if (categoryfilter) {
      ...
      CategoryServiceFilter(datas, pagecountnumbers).then((res) => {
        setServiceCategoryShow(false);
        setFilterproducts(res?.data?.results);
        setFilterproducts1(res?.data?.results);
...
export default SidebarServicecateogrys