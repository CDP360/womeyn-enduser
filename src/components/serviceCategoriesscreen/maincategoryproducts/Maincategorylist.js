...
import { ServiceCatgorylist } from '../../../services/service-category-service/service-category-services';
...
function Maincategorylist({ name, searchnamevalue, filterproducts, setFilterproducts, setLoadingproduct,
    ...
    const getproducts = () => {
        ...
        ServiceCatgorylist(name).then((res) => {
            seLimit(res?.data);
            ...
            <div>
                {loadingproduct ? <>
                    ...
                    {filterproducts1?.length === 0 ? <div>
                        ...
                        {filterproducts1?.map((item, index) => {
                            return (
                                <>
