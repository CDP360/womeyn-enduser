                                ...
                                <Form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className={styles.passwordformsection}>
                                        <Form.Group className="mb-2" controlId="formBasicEmail">
                                            ...
                                            <div className={"formsectioncommon"}>
                                                <Form.Control type={show2 ? "text" : "password"} placeholder="User@gmail.com" className={styles.forms}
                                    ...
                                    <div className='mt-4'>
                                        <div className={styles.passwordformsection}>
                                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                                ...
                                                <div className={"formsectioncommon"}>
                                                    <Form.Control type={show3 ? "text" : "password"} placeholder="User@gmail.com" className={styles.forms}
