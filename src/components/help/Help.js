                ...
                <div className={styles.mainsectionhelp}>
                    ...
                    <div className={styles.borderboxhelp}>
                        <div className={styles.ordersslice}>
                            ...
                            <div className={styles.arrowsection}>
                                {dropdown2 ? <ion-icon name="chevron-up-outline" size="large" onClick={() => setDropdown2(!dropdown2)}></ion-icon> :
                                    <ion-icon name="chevron-down-outline" size="large" onClick={() => setDropdown2(!dropdown2)}></ion-icon>}
                            </div>
                        </div>
                        {dropdown2 && <div>
                            <div className={styles.bordertopsection}>
                    ...
                    <div className={styles.borderboxhelp}>
                        <div className={styles.ordersslice}>
                            ...
                            <div className={styles.arrowsection}>
                                {dropdown3 ? <ion-icon name="chevron-up-outline" size="large" onClick={() => setDropdown3(!dropdown3)}></ion-icon> :
                                    <ion-icon name="chevron-down-outline" size="large" onClick={() => setDropdown3(!dropdown3)}></ion-icon>}
                            </div>
                        </div>
                        {dropdown3 && <div>
                            <div className={styles.bordertopsection}>
