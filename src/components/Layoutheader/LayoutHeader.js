        ...
        <>
            ...
            <div className={styles.mainheader}>
                <div className={styles.insidesectionlayout}>
                    ...
                    {title == "Profile" || title == "Women-login" || title == "Women-signup" || title == "Cart" || title == "Checkout" || title == "404 NotFound" || title == "Otp" || title == "Forgetpassword" || title == "Change-password" || title == "Explore" || title == "Events" || title == "passwordcreate" ?
                        <>
                        </>
                        :
                        <>
